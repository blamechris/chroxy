...
5. If target involves mobile app or Expo features: add Expo Expert
6. If target involves tunnels or networking: add Tunneler
...
```
<!-- skill-templates: recon a696a37 2026-05-18 -->
