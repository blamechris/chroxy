 ...
 */
export const LEGACY_THINKING_LEVELS: readonly string[] = Object.freeze(['default', 'high', 'max'])
 ...
 */
export function isWellFormedThinkingLevel(value: unknown): value is string {
...
export function formatThinkingLevelLabel(level: string): string {
  if (level === LEGACY_DEFAULT_THINKING_LEVEL) return 'Auto'
