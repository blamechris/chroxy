...
// on-demand request/reply pair and its own `countedAt` clock. Consumed by the
// server emitter (session-pr-threads.js + session-pr-threads-handlers.js), the
// dashboard store handler, and the CI prefill line.
export type ServerSessionPrThreadsMessage = z.infer<typeof ServerSessionPrThreadsSchema>
...
// #7625
export type ServerFailedRestoresListMessage = z.infer<typeof ServerFailedRestoresListSchema>
