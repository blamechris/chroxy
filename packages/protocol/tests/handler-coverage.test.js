...
const PLATFORM_SPECIFIC = {
  ...
  'session_pr_status': 'dashboard', // #7344 session PR/CI status chip — dashboard-only for the display slice (the mobile app header has no equivalent chip yet); mobile parity is a tracked follow-up
