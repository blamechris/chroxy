...
export interface ConnectionState {
  ...
  // View mode
  viewMode: 'chat' | 'terminal' | 'files' | 'diff' | 'system';
  ...
  setViewMode: (mode: 'chat' | 'terminal' | 'files' | 'diff' | 'system') => void;
  ...
  createSession: (name: string, cwd?: string, provider?: string) => void;
